use app_server_host::{ClientTransport, MpscTransportAdapter};
...
pub struct MpscAppServerTransportPort {
    inner: MpscTransportAdapter,
}

impl MpscAppServerTransportPort {
    pub fn new(inner: MpscTransportAdapter) -> Self {
        Self { inner }
    }

    pub fn into_inner(self) -> MpscTransportAdapter {
        self.inner
    }
}

impl AppServerTransportPort for MpscAppServerTransportPort {
    fn handshake(
        &mut self,
