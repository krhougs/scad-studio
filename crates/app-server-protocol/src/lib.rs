...
pub use protocol::{
    ...
    AgentModelSource, AgentPlanConfirmRequest, AgentPlanPackageRef, AgentPlanProposedEvent,
    AgentPlanRejectRequest, AgentPlanSavedEvent, AgentProviderCapabilities, AgentProviderType,
    AgentReasoningEvent, AgentRuntimeStatus, AgentSearchSource, AgentSnapshotRequest,
    AgentSnapshotResponse, AgentStartTurnRequest, AgentStartedResponse, AgentSubscribeRequest,
    AgentSubscribeResponse, AgentTokenEvent, AgentToolResultEvent, AgentToolStartEvent,
    AgentTurnId, AppConfigDto, BoundAgentModel, CURRENT_PROTOCOL_VERSION, CadQueryArtifactExport,
    CadQueryArtifactRelation, CadQueryExecuteRequest, CadQueryExportFormat, CadQueryFeatureFaces,
    CadQueryMeshPayload, CadQueryObjectKind, CadQueryPartMesh, CadQueryPreviewRequest,
    CadQueryResultGetRequest, CadQueryResultReady, CancelRequest, CapabilityHandshakeRequest,
    CapabilityHandshakeResponse, ChatAckResponse, ChatArchiveRequest, ChatArchivedResponse,
    ChatCreateInitialTurn, ChatCreateRequest, ChatCreatedResponse, ChatHistoryRequest,
