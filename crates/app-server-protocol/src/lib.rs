...
pub use protocol::{
    ...
    AgentModelSelectRequest, AgentModelSource, AgentPlanConfirmRequest, AgentPlanPackageRef,
    AgentPlanProposedEvent, AgentPlanRejectRequest, AgentPlanSavedEvent, AgentProviderCapabilities,
    AgentReasoningEvent, AgentSearchSource, AgentStartedResponse, AgentTokenEvent,
